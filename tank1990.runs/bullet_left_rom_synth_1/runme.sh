...
HD_PWD='C:/Users/flyin/Desktop/ECE_385/tank1990/tank1990.runs/bullet_left_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bullet_left_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bullet_left_rom.tcl
