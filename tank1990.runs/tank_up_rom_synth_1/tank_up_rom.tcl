...
synth_design -top tank_up_rom -part xc7s50csga324-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix tank_up_rom_ tank_up_rom.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ tank_up_rom_stub.v
 lappend ipCachedFiles tank_up_rom_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ tank_up_rom_stub.vhdl
 lappend ipCachedFiles tank_up_rom_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ tank_up_rom_sim_netlist.v
 lappend ipCachedFiles tank_up_rom_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ tank_up_rom_sim_netlist.vhdl
 lappend ipCachedFiles tank_up_rom_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp tank_up_rom.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips tank_up_rom]
 }
...
rename_ref -prefix_all tank_up_rom_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef tank_up_rom.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "tank_up_rom_synth_1_synth_report_utilization_0" "report_utilization -file tank_up_rom_utilization_synth.rpt -pb tank_up_rom_utilization_synth.pb"
...
OPTRACE "tank_up_rom_synth_1" END { }
