...
HD_PWD='C:/Users/flyin/Desktop/ECE_385/tank1990/tank1990.runs/base_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_rom.tcl
