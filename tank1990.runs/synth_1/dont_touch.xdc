...
# IP: ip/bullet_right_rom_1/bullet_right_rom.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==bullet_right_rom || ORIG_REF_NAME==bullet_right_rom} -quiet] -quiet

# IP: ip/bullet_left_rom_1/bullet_left_rom.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==bullet_left_rom || ORIG_REF_NAME==bullet_left_rom} -quiet] -quiet

# IP: ip/bullet_down_rom_1/bullet_down_rom.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==bullet_down_rom || ORIG_REF_NAME==bullet_down_rom} -quiet] -quiet

# IP: ip/bullet_up_rom_1/bullet_up_rom.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==bullet_up_rom || ORIG_REF_NAME==bullet_up_rom} -quiet] -quiet
