...
#
# Generated by export_simulation on Thu Apr 24 22:36:04 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './tank_down_rom.sh' script.

./tank_down_rom.sh -reset_run
...
./tank_down_rom.sh -noclean_files

For more information on the script, please type './tank_down_rom.sh -help'.
