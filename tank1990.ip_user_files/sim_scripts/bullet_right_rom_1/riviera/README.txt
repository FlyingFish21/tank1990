...
#
# Generated by export_simulation on Fri May 02 17:52:39 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './bullet_right_rom.sh' script.

./bullet_right_rom.sh -reset_run
...
./bullet_right_rom.sh -noclean_files

For more information on the script, please type './bullet_right_rom.sh -help'.
