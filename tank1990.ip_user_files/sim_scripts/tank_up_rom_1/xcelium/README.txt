...
#
# Generated by export_simulation on Thu Apr 24 22:35:21 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './tank_up_rom.sh' script.

./tank_up_rom.sh -reset_run
...
./tank_up_rom.sh -noclean_files

For more information on the script, please type './tank_up_rom.sh -help'.
