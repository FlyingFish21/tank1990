...
#
# Generated by export_simulation on Fri May 02 17:51:45 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './bullet_left_rom.sh' script.

./bullet_left_rom.sh -reset_run
...
./bullet_left_rom.sh -noclean_files

For more information on the script, please type './bullet_left_rom.sh -help'.
