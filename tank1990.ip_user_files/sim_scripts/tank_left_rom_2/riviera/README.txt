...
#
# Generated by export_simulation on Thu Apr 24 21:42:43 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './tank_left_rom.sh' script.

./tank_left_rom.sh -reset_run
...
./tank_left_rom.sh -noclean_files

For more information on the script, please type './tank_left_rom.sh -help'.
