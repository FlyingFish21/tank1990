...
#
# Generated by export_simulation on Thu Apr 24 22:57:44 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './bullet_up_rom.sh' script.

./bullet_up_rom.sh -reset_run
...
./bullet_up_rom.sh -noclean_files

For more information on the script, please type './bullet_up_rom.sh -help'.
