...
#
# Generated by export_simulation on Sun May 04 17:17:57 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './bullet_down_rom.sh' script.

./bullet_down_rom.sh -reset_run
...
./bullet_down_rom.sh -noclean_files

For more information on the script, please type './bullet_down_rom.sh -help'.
